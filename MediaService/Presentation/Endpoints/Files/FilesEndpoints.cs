...
public static class FileEndpoints
{
    public static IEndpointRouteBuilder MapFileEndpoints(this IEndpointRouteBuilder app)
    {
        ...
        group.MapPost("/presigned-upload",
            async ([FromBody] PresignedRequestDto presignedRequestDto, IFileService fileService, CancellationToken cancellationToken) =>
                {
        ...
        group.MapPost("/confirm-upload",
            async ([FromBody] ConfirmUploadDto confirmUploadDto, IFileService fileService, CancellationToken cancellationToken) =>
                {
