...
public static class FileEndpoints
{
    public static IEndpointRouteBuilder MapFileEndpoints(this IEndpointRouteBuilder app)
    {
        ...
        group.MapPost("/presigned-upload", async (
            [FromBody] PresignedRequestDto presignedRequestDto,
        ...
        group.MapPost("/confirm-upload", async (
            [FromBody] ConfirmUploadDto confirmUploadDto,
            IFileService fileService,
            CancellationToken cancellationToken
        ) =>
            {
        ...
        .WithDescription("Confirm that a file has been uploaded successfully.");
